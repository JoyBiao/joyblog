    ...
    <div className={styles.userDetail}>
      <div className={styles.left}>
        <div className={styles.userInfo}>
          ...
          <Link href="/user/profile">
            <Button>Edit personal infomation</Button>
          </Link>
        </div>
        <Divider />
      ...
      <div className={styles.right}>
        <div className={styles.achievement}>
          <div className={styles.header}>Personal achievement</div>
          <div className={styles.number}>
            <div className={styles.wrapper}>
              <FundViewOutlined />
              <span>Wrote {articles?.length} articles</span>
            </div>
            <div className={styles.wrapper}>
              <FundViewOutlined />
              <span>Articles have been read {viewsCount} times</span>
            </div>
          </div>
        </div>
      </div>
